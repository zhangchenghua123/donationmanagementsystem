...
public class DoneeDetailJPanel extends JPanel{
	...
	public DoneeDetailJPanel(Donee donee){
		setBounds(GetResourceClass.getRealSize(300), GetResourceClass.getRealSize(5), 
				GetResourceClass.getRealSize(895), GetResourceClass.getRealSize(640));
		setLayout(null);
		setOpaque(false);
		...
		mainexperienceLabel.setBounds(GetResourceClass.getRealSize(25), GetResourceClass.getRealSize(200),
				GetResourceClass.getRealSize(150), GetResourceClass.getRealSize(50));
		...
		experienceArea.setBounds(GetResourceClass.getRealSize(175), GetResourceClass.getRealSize(200), 
				GetResourceClass.getRealSize(500), GetResourceClass.getRealSize(50));
