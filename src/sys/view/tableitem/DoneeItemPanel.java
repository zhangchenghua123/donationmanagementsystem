...
//		setBackground(Color.gray);
		...
		nameLabel.setBounds(GetResourceClass.getRealSize(120), GetResourceClass.getRealSize(15),GetResourceClass.getRealSize( 75), GetResourceClass.getRealSize(25));
		...
		genderLabel.setBounds(GetResourceClass.getRealSize(120), GetResourceClass.getRealSize(90), GetResourceClass.getRealSize(60), GetResourceClass.getRealSize(14));
		...
		birthdataLabel.setBounds(GetResourceClass.getRealSize(200), GetResourceClass.getRealSize(90), GetResourceClass.getRealSize(140), GetResourceClass.getRealSize(14));
		add(birthdataLabel);
		
		String s="<html>需要资助:&nbsp&nbsp&nbsp<font color='red'><b>"+donee.getExpectedamount()+"元</b></font>";
		expectedLabel=new JLabel(s);
		expectedLabel.setBounds(GetResourceClass.getRealSize(400), GetResourceClass.getRealSize(90), GetResourceClass.getRealSize(150), GetResourceClass.getRealSize(16));
		expectedLabel.setFont(new Font("黑体",Font.PLAIN,GetResourceClass.getRealSize(14)));
		add(expectedLabel);
		
		jinduLabel=new JLabel("进度:");
		jinduLabel.setBounds(GetResourceClass.getRealSize(120),GetResourceClass.getRealSize(112), GetResourceClass.getRealSize(52), GetResourceClass.getRealSize(14));
		...
		baifenbiLabel.setBounds(GetResourceClass.getRealSize(255), GetResourceClass.getRealSize(112), GetResourceClass.getRealSize(40), GetResourceClass.getRealSize(14));
		...
		haixujuanzhuLabel.setBounds(GetResourceClass.getRealSize(320), GetResourceClass.getRealSize(112), GetResourceClass.getRealSize(150), GetResourceClass.getRealSize(16));
