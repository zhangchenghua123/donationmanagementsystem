 ...
 *
 */
public class StopInstenceItemPanel extends JPanel {
	...
	public StopInstenceItemPanel(final Donee donee){
		this.donee=donee;
		setLayout(null);
		setOpaque(true);
...
//		
		...
		String s1="<html>接受资助:&nbsp&nbsp&nbsp<font color='red'><b>"+donee.getDonatedamount()+"元</b></font>";
		tolDonationLabel=new JLabel(s1);
		tolDonationLabel.setBounds(GetResourceClass.getRealSize(200), GetResourceClass.getRealSize(50), 
				GetResourceClass.getRealSize(150), GetResourceClass.getRealSize(16));
		tolDonationLabel.setFont(new Font("黑体",Font.PLAIN,GetResourceClass.getRealSize(14)));
