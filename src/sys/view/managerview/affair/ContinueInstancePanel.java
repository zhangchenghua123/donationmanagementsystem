 ...
 *
 */
public class ContinueInstancePanel extends JPanel {
	...
	public ContinueInstancePanel(){
		...
		doneesList=DoneePresenter.getDoneeByCondition(affairManager.getTaskId(), "continue");
		if(doneesList==null||doneesList!=null&&doneesList.size()==0){
			...
			for (int i = 0; i < doneesList.size(); i++) {
				ContinueInstanceItemPanel itemPanel = new ContinueInstanceItemPanel(
						doneesList.get(i));
